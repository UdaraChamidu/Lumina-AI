...
export default function Header({ session, manualEmail, isPremium, promptCount, maxLimit, onLogin, onLogout, onOpenProfile, onToggleSidebar }) {
  ...
  return (
    <header className="flex items-center justify-between px-4 md:px-6 py-4 pt-[calc(1rem+env(safe-area-inset-top))] bg-white/80 dark:bg-[#0F1016]/80 backdrop-blur-md border-b border-gray-200 dark:border-white/5 transition-colors duration-300">
      {/* Brand */}
